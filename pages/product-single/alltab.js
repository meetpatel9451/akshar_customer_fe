...
import rv1 from '/public/images/resource/author-1.png'
import rv2 from '/public/images/resource/author-1.png'
                            ...
                            <div className="comments-area">
                                <div className="comment-box">
                                    <div className="comment">
                                        <div className="author-thumb"><Image src={rv1} alt="" /></div>
                                ...
                                <div className="comment-box reply-comment">
                                    <div className="comment">
                                        <div className="author-thumb"><Image src={rv2} alt="" /></div>
                                        <div className="comment-inner">
