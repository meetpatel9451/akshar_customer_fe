...
import pImg from '/public/images/resource/project-3.jpg'
...
const ProjectSinglePage = (props) => {
    ...
    return (
        <Fragment>
            <Navbar />
            <PageTitle pageTitle={projectDetails?.subTitle} pagesub={'Project'} />
                            ...
                            <div className="row clearfix">
                                ...
                                <div className="column col-lg-3 col-md-6 col-sm-12">
                                    <ul className="social-box">
                                        ...
                                        <li className="google"><Link href="/" className="fa fa-google"></Link></li>
                                    </ul>
                                </div>
